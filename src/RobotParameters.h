...
namespace RobotParameters {
    ...
    static constexpr double k_maxSpeed = 10; // in/s
    static constexpr double k_maxAccel = 10; // in/s^2
    static constexpr double k_maxDeccel = -10; // in/s^2
    static constexpr double k_maxCentripAccel = 20; // in/s^2
    static constexpr double k_cornerStiffCoeff = 0; // 0.2;
