...
namespace RobotParameters {
    ...
    static constexpr double k_maxAccel = 80; // in/s^2
    static constexpr double k_maxDeccel = -120; // in/s^2
    static constexpr double k_maxCentripAccel = 40; // in/s^2
    ...
    static constexpr double k_driveMotorControllerKap = 0.0001;
    ...
    static constexpr double k_pathFollowerKpTurn = 0;//0.002;
